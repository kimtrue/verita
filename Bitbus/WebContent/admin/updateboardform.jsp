      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            ...
            <form action="updateboardform.do" method="post" enctype="multipart/form-data">
                  ...
                  <colgroup>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><input type="text" style="width:100%;height:50px;" name="title" value="${list.title}"/></td>
                      </tr>
                      <tr>
                          ...
                          <tr>
                              ...
                              <td>                             
                                  <div>
                                  	<a href="downloadfile.do?path=${file.path}&orgName=${file.orgName}">${file.orgName}</a>
                                  	  <button type="button" onclick="location.href='deletefile.do?${file.path}'">삭제</button>                             	
                                  </div>
                              </td>
                          </tr>
                    </tbody>
          ...
          <div class="downinput" style="text-align: left;">
              <input type="submit" class="btnservice"  value="수정하기" />
