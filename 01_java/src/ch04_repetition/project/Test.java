			...
			if (isLogin == false) {
				...
				case 1:
					...
					for(int i = 0; i < count ; i++) {
			     		if (loginId.equals(arr[i].id) && loginPass.equals(arr[i].pass)) {
						isLogin = true;
						loginMsg = "로그인 되었습니다.";
						index = i;
					}
				...
				case 2:
					...
					if(count == arr.length) {
						System.out.println("가입할 수 있는 회원수가 초과되었습니다");
						break;
					}
				...
				case 2:
					...
					System.out.println();
					System.out.println("-------------------------------");
					System.out.println("아이디 : " + arr[index].id);
					System.out.println("패스워드 : " + arr[index].pass);
					System.out.println("이름 : " + arr[index].name);
					System.out.println("생년월일 : " + arr[index].birth);
					System.out.println("주소 : " + arr[index].addr);
					while (true) {
						System.out.println("-------------------------------");
